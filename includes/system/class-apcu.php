...
class APCu {
	...
	public static function delete( $objects ) {
		...
		if ( function_exists( 'apcu_delete' ) ) {
			...
			\DecaLog\Engine::eventsLogger( MAILARCHIVER_SLUG )->info( sprintf( '%d object(s) deleted.', $cpt ) );
		}
		return $cpt;
	}
	...
	public static function reset() {
		if ( function_exists( 'apcu_cache_info' ) && function_exists( 'apcu_delete' ) ) {
			...
			\DecaLog\Engine::eventsLogger( MAILARCHIVER_SLUG )->notice( 'Cache cleared.' );
		}
	}
