<?php
/**
 * Libraries autoload for MailArchiver.
 *
 * @package Libraries
...
spl_autoload_register(
	function ( $class ) {
		$file = '';
		foreach ( Mailarchiver\Library\Libraries::get_psr4() as $library ) {
		...
		if ( '' === $file ) {
			foreach ( Mailarchiver\Library\Libraries::get_mono() as $library ) {
