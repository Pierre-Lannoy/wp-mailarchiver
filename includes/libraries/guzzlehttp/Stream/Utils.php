<?php
namespace MAGuzzleHttp\Stream;

use MAGuzzleHttp\Stream\Exception\SeekException;
...
class Utils
{
    ...
    /**
     * Alias of MAGuzzleHttp\Stream\Stream::factory.
     *
     * @param mixed $resource Resource to create
     * @param array $options  Associative array of stream options defined in
     *                        {@see \MAGuzzleHttp\Stream\Stream::__construct}
     *
     * @return StreamInterface
     *
     * @see MAGuzzleHttp\Stream\Stream::factory
     * @see MAGuzzleHttp\Stream\Stream::__construct
     */
