...
class HandlerTypes {
	...
	public function __construct() {
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'Any record it can handle will be thrown away.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'class'         => 'debugging',
			'minimal'       => Logger::DEBUG,
			'name'          => esc_html__( 'Browser console', 'mailarchiver' ),
			'help'          => esc_html__( 'An events log sent to browser\'s javascript console with no browser extension required.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'class'         => 'debugging',
			'minimal'       => Logger::DEBUG,
			'name'          => esc_html__( 'ChromePHP', 'mailarchiver' ),
			'help'          => esc_html__( 'An events log sent to the ChromePHP extension (http://www.chromephp.com/).', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'An events log sent to a Fluentd collector.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'An events log sent to Logentries & insightOps service.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'An events log sent to Solawinds Loggly service.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'Events alerts sent by WordPress via mail.', 'mailarchiver' ),
			...
			'configuration' => [
				'recipients' => [
					'type'    => 'string',
					'show'    => true,
					'name'    => esc_html__( 'Recipients', 'mailarchiver' ),
					'help'    => esc_html__( 'The recipients mail address, in coma separated list.', 'mailarchiver' ),
					'default' => '',
					'control' => [
						'type'    => 'field_input_text',
						'cast'    => 'string',
		...
		$this->handlers[] = [
			...
			'class'         => 'logging',
			'minimal'       => Logger::DEBUG,
			'name'          => esc_html__( 'PHP error log', 'mailarchiver' ),
			'help'          => esc_html__( 'An events log stored in the standard PHP error log, as with the error_log() function.', 'mailarchiver' ),
			'icon'          => $this->get_base64_php_icon(),
			'params'        => [ 'processors', 'privacy' ],
			'configuration' => [],
			'init'          => [
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'Events alerts sent via Pushover service.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'An events log sent to files that are rotated every day and a limited number of files are kept.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'Events alerts sent through Slack Webhooks.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'An events log sent to a remote syslogd server.', 'mailarchiver' ),
		...
		$this->handlers[] = [
			...
			'help'          => esc_html__( 'An events log stored in your WordPress database and available right in your admin dashboard.', 'mailarchiver' ),
			...
			'configuration' => [
				'rotate' => [
					'type'    => 'integer',
					'show'    => true,
					'name'    => esc_html__( 'Events', 'mailarchiver' ),
					'help'    => esc_html__( 'Maximum number of events stored in this events log (0 for no limit).', 'mailarchiver' ),
					'default' => 10000,
					'control' => [
						'type'    => 'field_input_integer',
						'cast'    => 'integer',
				...
				'purge'  => [
					...
					'help'    => esc_html__( 'Maximum age of events stored in this events log (0 for no limit).', 'mailarchiver' ),
					'default' => 15,
					'control' => [
						'type'    => 'field_input_integer',
						'cast'    => 'integer',
				...
				'local'  => [
					...
					'help'    => esc_html__( 'Local administrators can view events that relate to their site.', 'mailarchiver' ),
					'default' => false,
					'control' => [
						'type'    => 'field_checkbox',
						'cast'    => 'boolean',
