<?php
/**
 * Litmus handler for Monolog
 *
 * Handles all features of Litmus handler for Monolog.
 *
 * @package Handlers
...
/**
 * Define the Monolog Litmus handler.
 *
 * Handles all features of Litmus handler for Monolog.
 *
 * @package Handlers
 ...
 * @since   2.5.0
 */
class LitmusHandler extends AbstractBufferedMailHandler {
